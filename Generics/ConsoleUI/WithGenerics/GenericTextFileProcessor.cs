...
namespace ConsoleUI
{
    ...
    {
        public static List<T> LoadFromTextFile<T>(string filePath) where T : class, new() // These are limitations that necessitate T to be a class and have an empty constructor
        {
